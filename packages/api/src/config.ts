...
export const DATABASE_URL = process.env.DATABASE_URL ?? "localhost:5432/moba";
...
export const MONO_BVN_SESSION_ID_CACHE_KEY = "mono-bvn-session-id"
export const MONO_BVN_SESSION_ID_TTL = 10 * 60 // 10m in seconds
...
export const MONO = {
    ...
    accountPath: process.env.MONO_ACCOUNT_PATH ?? "/v2/accounts",
